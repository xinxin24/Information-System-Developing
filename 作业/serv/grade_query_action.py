...
# @web_routes.post('/action/grade-query/add')
# async def action_grade_query_add(request):
#     params = await request.post()
#     stu_sn = params.get("stu_sn")
#     cou_sn = params.get("cou_sn")
   
#     grade = params.get("grade_query")
...
#     return web.HTTPFound(location="/grade_query")


# @web_routes.post('/action/grade-query/edit/{stu_sn}/{cou_sn}')
# async def edit_grade_query_action(request):
...
#     return web.HTTPFound(location="/grade-query")


# @web_routes.post('/action/grade-query/delete/{stu_sn}/{cou_sn}')
